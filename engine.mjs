...
export const modelVersion='2026.09.18';
export const lifeExpectancyAt65={male:19.47,female:24.38};
...
return{errors:[],limits:contributionLimits(x),before,after,social,tax,resident,savings,totalSavings:savings*months/12,netReduction:(x.personal+x.matching)*12-savings,monthlyContribution:x.company+x.personal+x.matching,annualContribution:(x.company+x.personal+x.matching)*12,capital:(x.company+x.personal+x.matching)*months,companyCapital:x.company*months,personalCapital:(x.personal+x.matching)*months,selectiveCapital:x.personal*months,matchingCapital:x.matching*months,months,pensionAnnualLoss:pensionLoss,pensionMonthlyLoss:pensionLoss/12,pensionLifetimeLossMale:pensionLoss*lifeExpectancyAt65.male,pensionLifetimeLossFemale:pensionLoss*lifeExpectancyAt65.female};}
